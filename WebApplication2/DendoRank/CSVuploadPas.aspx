<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSVuploadPas.aspx.cs" Inherits="WebApplication2.DendoRank.CSVuploadPas" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h1>データ形式について</h1>
        注）このアップロード画面から登録すると全データを置き換えます。<br />
        データは殿堂登録曲のすべてを含めるようにしてください。<br />
<pre>集計年度,ジャンル,評価,曲名,作者,演奏時間(秒),メンバー数,ファイルサイズ</pre>
...
　ファイルサイズを入力(半角数字)</li></ul>
        ...
        データ例
        <pre>
        "2017","ポピュラー","2","ロ・ロ・ロ・ロシアンルーレット","MIZ","224","16","9931"
        </pre>
    </form>
</body>
</html>
